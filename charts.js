...
function buildCharts(sample) {
  ...
  var metadata = data.metadata;
  var gauge = metadata.filter(sampleObject => sampleObject.id == sample)

  // 2. Create a variable that holds the first sample in the metadata array.
  var firstsample = gauge[0]
  ...
  var gaugeData = [{
    ...
    type: 'indicator',
    mode: 'gauge+number',
    title: {text: "<b>Belly Button Washing Freq</b><br> Scrubs per week"},
    gauge: {
